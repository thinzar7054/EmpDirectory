...
public class AdminDetailsController {
    ...
    public boolean saveAdminDetails() {
        try (Connection con = db.getConnection()) {
            ...
            pst.setString(10, model.getAdmId());  // Use emp_id from model
    ...
    private String getJobIdByName(Connection con, String postName) {
        String jobId = null;
        String sql = "SELECT post_id FROM postition WHERE positionName = ?";
        try (PreparedStatement stmt = con.prepareStatement(sql)) {
