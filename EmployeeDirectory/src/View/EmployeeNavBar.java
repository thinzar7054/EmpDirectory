...
public class EmployeeNavBar extends JFrame {
	...
	private void createPanels() {
		...
		panels.put("EmployeeDashboard", new EmpDashboardUserPanel(this));
		panels.put("EmployeeDetails", new EmployeeDetailUserView(this));  // Add this line
