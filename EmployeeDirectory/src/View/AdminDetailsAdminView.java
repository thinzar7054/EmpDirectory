...
public class AdminDetailsAdminView extends JPanel {
   ...
   // private EmployeeDetailsModel currentModel;
	...
	//	setLayout(null);
		...
		btnSave.addActionListener(e -> saveAdminDetails());  // Link to save method
		panel.add(btnSave);
	...
	private void saveAdminDetails() {
	    ...
	    if (currentModel == null) {
	        JOptionPane.showMessageDialog(this, "No admin data loaded.", "Error", JOptionPane.ERROR_MESSAGE);
	        return;
	    }
